...
console.log()
    ...
    return (
      ...
      > 
        <motion.div animate={{background: done? "#000" : "rgba(146, 146, 146, 0.25)"}} className={styles.container} >
          <div className={styles.todo_image} style={{backgroundColor: props.category.color}}>
